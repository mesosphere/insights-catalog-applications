...
IMAGE_TAR_FILE := $(IMAGE_BUILD_DIR)/dkp-insights-image-bundle.tar.gz
...
ifeq ($(CATALOG_APPLICATIONS_VERSION),"")
	...
	aws s3 cp --no-progress --acl bucket-owner-full-control $(IMAGE_TAR_FILE) s3://$(RELEASE_S3_BUCKET)/airgapped/$(CATALOG_APPLICATIONS_VERSION)/dkp_insights_image_bundle_$(CATALOG_APPLICATIONS_VERSION)_linux_amd64.tar.gz
endif
